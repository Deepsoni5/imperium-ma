            ...
            <form className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  ...
                  <Input className="bg-luxe-black border-white/10 text-white rounded-none h-12 focus:border-gold transition-colors" placeholder="John Doe" />
                </div>
                <div className="space-y-2">
                  <label className="text-[10px] uppercase tracking-widest text-zinc-500 font-medium">Email Address</label>
                  <Input className="bg-luxe-black border-white/10 text-white rounded-none h-12 focus:border-gold transition-colors" placeholder="john@company.com" />
                </div>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  <label className="text-[10px] uppercase tracking-widest text-zinc-500 font-medium">Phone Number</label>
                  <Input className="bg-luxe-black border-white/10 text-white rounded-none h-12 focus:border-gold transition-colors" placeholder="+91 00000 00000" />
                </div>
                <div className="space-y-2">
                  <label className="text-[10px] uppercase tracking-widest text-zinc-500 font-medium">Company Name</label>
                  <Input className="bg-luxe-black border-white/10 text-white rounded-none h-12 focus:border-gold transition-colors" placeholder="Acme Corp" />
                </div>
              </div>
              <div className="space-y-2">
                <label className="text-[10px] uppercase tracking-widest text-zinc-500 font-medium">Transaction Type</label>
                <Input className="bg-luxe-black border-white/10 text-white rounded-none h-12 focus:border-gold transition-colors" placeholder="Sell-side / Buy-side / Other" />
              </div>
              <div className="space-y-2">
                <label className="text-[10px] uppercase tracking-widest text-zinc-500 font-medium">Message</label>
                <Textarea className="bg-luxe-black border-white/10 text-white rounded-none min-h-[150px] focus:border-gold transition-colors" placeholder="Please describe your inquiry briefly..." />
              </div>
              <Button size="lg" className="w-full bg-gold hover:bg-gold-muted text-black font-semibold h-16 rounded-none mt-4 group transition-all">
